...
def setup(name=__name__,logdir='log',console=True,text=True,loglevel='DEBUG',logfile=None):
    ...
    handler_list = []
    if console: handler_list.append('console')
    if text: handler_list.append('text')
...
def resolveVerbosity(verbosity_level):
    '''
    ...
    '''
    if verbosity_level <= 0: loglevel=logging.ERROR
    elif verbosity_level == 1: loglevel=logging.WARNING
    elif verbosity_level == 2: loglevel=logging.INFO
